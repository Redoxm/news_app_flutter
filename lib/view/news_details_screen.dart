...
import 'package:flutter_news_app/widgets/news_details_app_bar.dart';
import 'package:flutter_news_app/widgets/news_details_constant.dart';
import 'package:flutter_news_app/widgets/news_details_header.dart';
import 'package:flutter_news_app/widgets/releated_articles.dart';
...
class _NewsDetailsScreenState extends State<NewsDetailsScreen>
  ...
  void _onScroll() {
    ...
    setState(() {
      _scrollProgress = (scrollPosition / (maxScroll + viewportHeight)).clamp(
        0.0,
        1.0,
      );
      ...
      body: FadeTransition(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            SliverToBoxAdapter(child: RelatedArticles()),
          ],
        ),
      ),
    );
